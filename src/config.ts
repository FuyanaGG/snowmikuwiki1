...
export const siteConfig: SiteConfig = {
	title: "SnowMikuWiki",
	subtitle: "ウェブサイトの展開が進行中...",
	siteURL: "https://snowmiku.wiki/", // 请替换为你的站点URL，以斜杠结尾
	...
	themeColor: {
		hue: 245, // HSL(色相 Hue)主题色的默认色相（目前是初音未来本色#39C5BB），范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	bilibili: {
		vmid: "631231797", // 在此处设置你的Bilibili用户ID (vmid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "雪ミクウィキ", // 主页横幅主标题

			subtitle: [
				"(1.2.3.4. happy patisserie for you!",
				"きみと見るこの景色 大切に凍らせて",
				"今日は特別な日 我慢してた分全部食べちゃおう",
		        "滲む想いグラデーション それはパステルカラー",
		        "サメナイ・トケナイ・大冒険であったかい",
		        "曇りゆく空があるなら 足元に銀河を描いて",
		        "美しいのさ 笑うも泣くもその全てを 振り返るのは今日くらいだから 贈るよ",
		        "変わっていいんだよ　もうじゃんじゃん君になっちゃって",
		        "オリジナルサイズの足跡をつけよう 君の歩幅でいい",
		        "積もっていく思い出がずっと何年も重なって 地球を覆うまできっと愛を歌うよ",
		        "この想い届くかな 雪がとける前に",
		        "長い夢が 覚める前に この想い 君に届けたい",
		        "絵本みたいな景色を 君に見せてあげるから",
		        "この瞬間 永遠に stay snow glitter snow glitter",
		        "溶かした世界に　未来が降る",
	...
	links: [
		{
			name: "Bilibili",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/631231797",
		},
		{
			name: "Twitter",
			icon: "fa6-brands:twitter",
			url: "https://x.com/Fuyana_Offical",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/FuyanaGG",
		},
		{
			name: "Pixiv",
			icon: "fa6-brands:pixiv",
			url: "https://www.pixiv.net/users/95617963",
		},
		{
			name: "Youtube",
			icon: "fa6-brands:youtube",
			url: "https://www.youtube.com/@%E8%8A%99%E4%BA%9A%E5%A8%9C",
		},
	],
};
...
export const footerConfig: FooterConfig = {
  ...
  customHtml: `
    ...
    <!-- 2. 再放你的 div -->
    <div style="text-align: center; padding: 20px 0; font-size: 15px; font-family: ... ; animation: breathe 3s ease-in-out infinite;">
      © 芙亚娜・Fuyana ❄️ SnowMikuWiki
    </div>
  `
};
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		link: "https://space.bilibili.com/631231797", // 关于链接
	},
};
